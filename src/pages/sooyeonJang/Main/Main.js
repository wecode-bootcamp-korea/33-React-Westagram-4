                 ...
                 <nav className="navbar">
                    <div className="nav-wrapper">
                        ...
                        <div className="nav-icons">
                            ...
                            <img src="images/send.png" alt="send" className="icon" />
                            <img src="images/plus.png" alt="plus" className="icon" />
                            <img src="images/compass.png" alt="compass" className="icon" />
                            <img src="images/heart.png" alt="likes" className="icon" />
                            <img src="images/user.png" alt="user" className="icon user-profile" />
                        </div>
                    </div>
                </nav>
                        ...
                        <div className="left-col">
                            <div className="status-wrapper">
                                <div className="status-card">
                                    <div className="status-pic">
                                        <img alt="profile-pic" src="https://images.unsplash.com/photo-1574517858464-7bfc583d16e7?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1325&q=80" />
                                        <p className="status-name">rhcp</p>
                                    </div>
                                </div>
                                <div className="status-card">
                                    <div className="status-pic">
                                        <img alt="profile-pic" src="https://images.unsplash.com/photo-1604514288114-3851479df2f2?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1471&q=80" />
                                        <p className="status-name">tim tomey</p>
                                    </div>
                                </div>
                                <div className="status-card">
                                    <div className="status-pic">
                                        <img alt="profile-pic" src="https://images.unsplash.com/photo-1598387181032-a3103a2db5b3?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NXx8cm9jayUyMGJhbmR8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60" />
                                        <p className="status-name">sam mog...</p>
                                    </div>
                                </div>
                                <div className="status-card">
                                    <div className="status-pic">
                                        <img alt="profile-pic" src="https://images.unsplash.com/photo-1549834125-82d3c48159a3?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTZ8fHJvY2slMjBiYW5kfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60" />
                                        <p className="status-name">austin wade</p>
                                    </div>
                                </div>
                                <div className="status-card">
                                    <div className="status-pic">
                                        <img alt="profile-pic" src="https://images.unsplash.com/photo-1596827391559-de49a8f619e5?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MjV8fHJvY2slMjBiYW5kfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60" />
                                        <p className="status-name">quinton co...</p>
                                    </div>
                                </div>
                                <div className="status-card">
                                    <div className="status-pic">
                                        <img alt="profile-pic" src="https://images.unsplash.com/photo-1619961601586-0bd6b291164a?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NTB8fHJvY2slMjBiYW5kfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60" />
                            ...
                            <article className="post">
                                <div className="post-info">
                                    ...
                                    <img className="options" src="images/dots.png" alt="ellipsis" />
                                </div>
                                <img className="post-image" alt="feed-pic" src="https://images.unsplash.com/photo-1517411032315-54ef2cb783bb?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=765&q=80" />
                                <div className="post-content">
                                    <div className="reaction-wrapper">
                                        <img alt="likes" src="images/heart.png" className="r-icon" />
                                        <img alt="comments" src="images/bubble.png" className="r-icon" />
                                        <img alt="send" src="images/send.png" className="r-icon" />
                                    </div>
                                    ...
                                    <div className="comment-place"></div>
                                </div>
                                <div className="comment-wrapper">
                                    <img alt="smile" src="images/smile.png" className="smile-icon" />
                            ...
                            <article className="post">
                                ...
                                <img className="post-image" alt="feed-pic" src="https://images.unsplash.com/photo-1532986701744-5cee048ef948?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80" />
                                <div className="post-content">
                                    <div className="reaction-wrapper">
                                        <img alt="likes" src="images/heart.png" className="r-icon" />
                                        <img alt="comments" src="images/bubble.png" className="r-icon" />
                                ...
                                <div className="comment-wrapper">
                                    <img alt="smile" src="images/smile.png" className="smile-icon" />
                                    <input type="text" class="comment-box" placeholderName="Add a comment..." />
                                    <button className="comment-btn">Post</button>
                                </div>
                            </article>
                            <article className="post">
                                ...
                                <img className="post-image" alt="feed-pic" src="https://images.unsplash.com/photo-1563729784474-d77dbb933a9e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80" />
                                <div className="post-content">
                                    <div className="reaction-wrapper">
                                        <img alt="likes" src="images/heart.png" className="r-icon" />
                                        <img alt="comments" src="images/bubble.png" className="r-icon" />
